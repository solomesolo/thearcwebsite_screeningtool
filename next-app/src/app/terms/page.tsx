...
export default function Terms() {
  return (
    <aside className="fixed top-0 right-0 h-screen w-full sm:w-[600px] bg-black text-white z-50 shadow-2xl flex flex-col items-center justify-center px-4 py-8 sm:px-8 sm:py-16 animate-slide-in max-h-screen overflow-y-auto font-montserrat">
      ...
      <div className="w-full max-w-2xl flex flex-col items-start mt-16">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">Content is Informational Only</h2>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">Waitlist Is Non-Binding</h2>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-2">Data Use</h2>
        <p className="mb-4">Your personal data will be handled in accordance with the Privacy Policy listed above.</p>
        <h2 className="text-xl font-semibold mt-6 mb-2">Program Terms May Vary</h2>
