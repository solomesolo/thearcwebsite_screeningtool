...
export default function About() {
  return (
    <aside className="fixed top-0 right-0 h-screen w-full sm:w-[600px] bg-black text-white z-50 shadow-2xl flex flex-col items-center px-4 py-8 sm:px-8 sm:py-16 animate-slide-in overflow-y-auto">
      ...
      <div className="w-full max-w-2xl flex flex-col items-start mt-16 pt-[5vh] min-h-0 pb-24">
